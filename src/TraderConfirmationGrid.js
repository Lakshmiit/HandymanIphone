...
//   useEffect(() => {
//     setLoading(true);
//     const url = `https://lmarttestapi-ctajf3hqfddkgebw.centralindia-01.azurewebsites.net/api/RaiseTicket/GetNotificationsByExistingDealerId?category=${category1}&district=${district1}&dealerId=${userId}`;
//     // alert(category);
//     // alert(district);
//     // alert(userId);
//     axios
...
//     if (confirmDelete) {
//       axios
//         .delete(`https://lmarttestapi-ctajf3hqfddkgebw.centralindia-01.azurewebsites.net/api/RaiseTicket/${ticketId}`)
//         .then(() => {
