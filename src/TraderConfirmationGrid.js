...
//   useEffect(() => {
//     setLoading(true);
//     const url = `https://handymanapiv6-g7dfa4fgcrd7f3h2.centralindia-01.azurewebsites.net/api/RaiseTicket/GetNotificationsByExistingDealerId?category=${category1}&district=${district1}&dealerId=${userId}`;
//     // alert(category);
//     // alert(district);
//     // alert(userId);
//     axios
...
//     if (confirmDelete) {
//       axios
//         .delete(`https://handymanapiv6-g7dfa4fgcrd7f3h2.centralindia-01.azurewebsites.net/api/RaiseTicket/${ticketId}`)
//         .then(() => {
