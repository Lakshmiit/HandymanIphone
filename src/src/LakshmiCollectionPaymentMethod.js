...
const getUploadItemByProductName = useCallback(async (productName) => {
    const url = `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/UploadLakshmiCollection/GetLakshmiCollectionsItemByProductName?productName=${encodeURIComponent(productName)}`;
  ...
  const putUploadItemStock = useCallback(async (itemObj, newStockLeftStr) => {
    ...
    const url = `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/UploadLakshmiCollection/UpdateLakshmiCollection?id=${encodeURIComponent(itemObj.id)}`;
    const res = await fetch(url, {
      method: 'PUT',
    ...
    if (!res.ok) {
      ...
      throw new Error(`Failed to update stock for ${itemObj.productName}: ${t}`);
                ...
                `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/LakshmiCollection/GetLakshmiCollectionDetails/${collectionId}`
                );
...
const handleUpdatePaymentMethod = async (e) => {
  ...
  try {
      ...
      let response = await fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/LakshmiCollection/UpdateLakshmiCollectionDetails/${collectionId}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
