  ...
  const fetchNumbers = async () => {
    try {
      const response = await fetch(
        "https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/Customer/download-json"
      );
...
useEffect(() => {
  ...
  const upsertReferral = async ({ record, numbersCsv }) => {
    ...
    if (record?.id) {
      const putUrl = `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ReferralPoints/UpdateReferralPoints?id=${encodeURIComponent(
        record.id
      )}`;
      ...
      const postUrl = `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ReferralPoints/UploadReferralPoints`;
  ...
  const handleRedeem = async () => {
    try {
     ...
     await fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/Auth/sendpromosms`, {
        method: "POST",
