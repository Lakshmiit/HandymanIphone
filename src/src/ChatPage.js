...
// //           `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/UserLikes/GetUserLikes?UserId=${userId}`
// //         );
// //         if (!response.ok) {
...
//   }
//   try {
//     await axios.delete(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatBot?id=${messageId}`);
...
// //         fetch('https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/MarkMessageSeen/UploadMessageSeenCount', {
// //           method: 'POST',
...
//     try {
//       const response = await fetch(
//         `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/customer/customerProfileData?profileType=${userType}&UserId=${userId}`
//       );
...
// //         const res = await fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatBot/GetChatMessagesByType?type=${type}`);
...
// //           `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatMessageTabSeenByUser/GetChatMessageTabSeenByUserById?id=${retrievedId}`
// //         );
...
//       types.map(type =>
//         fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatBot/GetChatMessagesByType?type=${type}`)
...
// //     // const counts = {};
// //     // for (const type of types) {
// //       const res = await fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatBot/GetChatBotByUserId?UserId=${userId}`);
...
//   //     try {
//   //       const response = await fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatBot/GetChatMessagesByType?type=${tabType}`);
...
//   //             try {
//   //               const res = await fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/FileUpload/download?generatedfilename=${photo}`);
...
//   const fetchMessages = async () => {
//     try {
//       const res = await fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatBot/GetChatMessagesByType?type=${tabType}`);
//       if (!res.ok) throw new Error('Failed to fetch messages');
//       const data = await res.json();
...
//     fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/MarkMessageSeen/GetMarkMessageSeenUsers?messageId=${selectedMessage.id}`)
//       .then(res => res.json())
//       .then(data => {
//         setMessageCounts(prev => ({
//           ...prev,
...
//   };
//   try {
//     const response = await fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatBot/UploadChatBot`, {
//       method: 'POST',
//       headers: { 'Content-Type': 'application/json' },
...
//     try {
//       const response = await fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/FileUpload/download?generatedfilename=${photoId}`);
//       const data = await response.json();
//       return {
//         src: photoId,
...
//   try {
//     await axios.put(
//       `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatBot/UpdateChatBot?id=${message.id}`,
//       {
//         id: message.id,
...
//     //   await axios.put(
//     //     `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/UserLikes/UpdateUserLikes?id=${existingLike.id}&userId=${userId}`,
//     //     updatedLike
//     //   );
...
//     //   await axios.post(
//     //     "https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/UserLikes/UploadUserLikesController",
//     //     newLike
//     //   );
...
// //   try {
// //     await axios.put(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatBot/UpdateChatBot?id=${message.id}`, {
// //       id: message.id,
// //       userName: message.userName,
// //       dateTime: message.dateTime,
// //       userId: message.userId,
...
// //     await axios.post("https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/UserLikes/UploadUserLikesController", {
// //       id: "string", 
// //       userLikesId: "string", 
// //       messageId: message.id,
// //       userId: userId,
...
// //       try {
// //         const response = await fetch(
// //           `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatMessageTabSeenByUser/UploadChatMessageTabSeenByUser`,
// //           {
// //             method: 'POST',
// //             headers: { 'Content-Type': 'application/json' },
...
// //           `https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/ChatMessageTabSeenByUser/UpdateChatMessageTabSeenByUser?id=${retrievedId}`,
// //           {
// //             method: 'PUT',
// //             headers: { 'Content-Type': 'application/json' },
