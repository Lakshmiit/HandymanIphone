...
// useEffect(() => {
//     fetch(`https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/BuyProduct/GetBuyProductDetailsById/${id}`)
//       .then((res) => res.json())
//       .then((data) => {
...
//           "https://handymanapiv15-cmhuc3b9fcd0eeb9.canadacentral-01.azurewebsites.net/api/BuyProduct/buyProductEdit",
//           {
//             method: "POST",
