...
//   useEffect(() => {
//     setLoading(true);
//     const url = `https://lmarttestapi-ctajf3hqfddkgebw.centralindia-01.azurewebsites.net/api/RaiseTicket/GetNotificationsByExistingDealerId?category=${category}&district=${district}&dealerId=${userId}`;
//     axios
//       .get(url)
//       .then((response) => {
